...
e = function() {
    var e = {
        ...
        getAnimal: function(t, a, r) {
            a--;
            var n = (t - 1900) % 12;
            return 0 !== n && e.getLichunOffset(t, a, r) < 0 && (n -= 1), e.Animals[n];
        },
